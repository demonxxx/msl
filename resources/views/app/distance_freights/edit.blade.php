    ...
    <div class="pageheader">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{url('/distance_freights/create')}}">Cập nhật</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font">Cập nhật đơn giá</h1>
                        <ul class="controls">
                            <li class="dropdown">
                    ...
                    <div class="tile-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{url("distance_freights/$dist_freight_id/update")}}" name="create-shipper-form" role="form" id="create-shipper-form" data-parsley-validate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="from" id="from" class="form-control" placeholder="Khoảng cách từ" value="<?php echo $dist_freight->from; ?>" required>
                                    @if ($errors->has('from'))
                                    <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="to" id="to" class="form-control" placeholder="Khoăng cách đến" value="<?php echo $dist_freight->to; ?>" required>
                                    @if ($errors->has('to'))
                                    <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="freight" id="freight" class="form-control" placeholder="Giá cước" value="<?php echo $dist_freight->freight; ?>" required>
